        ...
        <div style={{flex:1,overflowY:"auto",padding:"0 8px"}}>
          <NavSection title="Views">
            {(()=>{
              ...
              const views=[
                {id:"today",icon:Icons.today,label:"Today",count:todayCount,drop:dateDrop(todayStr(),"Today")},
                {id:"tomorrow",icon:Icons.upcoming,label:"Tomorrow",count:tomorrowCount,drop:dateDrop(tomorrowStr(),"Tomorrow"),noView:true},
                {id:"nextmon",icon:Icons.calendar,label:"Next Monday",count:nextMonCount,drop:dateDrop(nextMondayStr(),"Next Monday"),noView:true},
              ...
              return views.map(({id,icon,label,count,drop,noView})=>(
                <div key={id} {...(drop||{})}>
